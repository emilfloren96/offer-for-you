...
import { MOCK_PROFESSIONALS, SERVICE_CATEGORIES, REGIONS, type Professional } from '../data/marketplace';
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
          ...
          <div>
            <h2
              ...
              style={{ fontWeight: 700, fontSize: 17, color: 'var(--primary-blue)', margin: 0 }}
            >
              {pro.name}
            </h2>
...
export function ProDirectory({ initialCategory, initialRegion, onBack }: ProDirectoryProps) {
  ...
  const filtered = MOCK_PROFESSIONALS
  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: 'var(--bg-white)' }}>
      ...
      <div style={{ backgroundColor: 'var(--bg-light-grey)', padding: '40px 24px 32px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 15, color: '#4b5563', marginBottom: 24 }}>
            Alla proffs är verifierade och rankade med Energybrand Score.
          </p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginLeft: 'auto' }}>
              <span style={{ fontSize: 13, color: '#4b5563', fontWeight: 600 }}>
                {filtered.length} proffs{filtered.length !== 1 ? '' : ''}
              </span>
            </div>
          </div>
        </div>
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            <p style={{ fontSize: 16, color: '#4b5563' }}>
              Inga proffs hittades för den kombinationen.
            </p>
            <button
      ...
      {/* Contact modal */}
      {contactPro && (
        <ContactModal pro={contactPro} onClose={() => setContactPro(null)} />
      )}
    </main>
  );
}
